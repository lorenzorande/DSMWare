...
class DropboxSession(object):
	...
	print "response.read() done"
        ...
        self.request_token = oauth.OAuthToken.from_string(bufferedBody)
	...
	print "is going to have a response"
	...
	bufferedBody=response.read()
        ...
        self.token = oauth.OAuthToken.from_string(bufferedBody)
        return self.token
